...
// Accounts.
export type LinkPnftInstructionAccounts = {
  owner: Signer;
...
// Data.
export type LinkPnftInstructionData = { discriminator: Array<number> };

export type LinkPnftInstructionDataArgs = {};

export function getLinkPnftInstructionDataSerializer(): Serializer<
  LinkPnftInstructionDataArgs,
  LinkPnftInstructionData
> {
  return mapSerializer<
    ...
    LinkPnftInstructionData
  >(
    struct<LinkPnftInstructionData>(
      [['discriminator', array(u8(), { size: 8 })]],
      { description: 'LinkPnftInstructionData' }
    ),
    (value) => ({
      ...value,
      discriminator: [41, 221, 230, 24, 188, 105, 32, 50],
    })
  ) as Serializer<LinkPnftInstructionDataArgs, LinkPnftInstructionData>;
}

// Instruction.
export function linkPnft(
  context: Pick<Context, 'programs'>,
  input: LinkPnftInstructionAccounts
): TransactionBuilder {
  // Program ID.
  ...
  // Data.
  const data = getLinkPnftInstructionDataSerializer().serialize({});
