...
use crate::error::E7lSProtocolError;
use crate::instruction::accounts::CreateAccounts;
use crate::instruction::{CreateArgs, E7lSProtocolInstruction};
...
pub fn process_instruction<'a>(
    ...
    let instruction: E7lSProtocolInstruction =
        E7lSProtocolInstruction::try_from_slice(instruction_data)?;
    match instruction {
        E7lSProtocolInstruction::Create(args) => {
...
fn create<'a>(accounts: &'a [AccountInfo<'a>], args: CreateArgs) -> ProgramResult {
    ...
    if *ctx.accounts.system_program.key != system_program::id() {
        return Err(E7lSProtocolError::InvalidSystemProgram.into());
    }
